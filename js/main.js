...
function egyenletKalkulator(){
    ...
    if (diszkriminans>0) {
        ...
        document.getElementById("eredmeny").innerHTML=("<p>Az egyenletnek két valós gyöke, azaz két megoldása van X<sub>1</sub> és X<sub>2</sub>, azaz kettő pontban érinti az X tengelyt!<br> X<sub>1</sub>= "+x1+"<br> X<sub>2</sub>= "+x2+"</p>");
        document.getElementById("eredmeny").classList.add("text-success");
        ...
        document.getElementById("eredmeny").innerHTML=("<p>Az egyenletnek egy valós gyöke, azaz egy megoldása van X<sub>1</sub>, azaz egy pontban érinti az X tengelyt!<br> X<sub>1</sub>= "+x1+"</p>");
        document.getElementById("eredmeny").classList.add("text-success");        
    
    } else {

        document.getElementById("eredmeny").innerHTML=("<p>Az egyenletnek nincs valós gyöke, azaz nincs megoldása, nem érinti az x tengelyt!</p>");
        document.getElementById("eredmeny").classList.add("text-danger");
